					...
					if ($confirm_email != "yes" && $site_users_only != "yes") {
						$sidebar_where = (has_wpqa() && wpqa_plugin_version >= "5.7"?wpqa_sidebars("sidebar_where"):"sidebar");
	...
	if ($footer_style != "sidebar") {
		$hide_footer_mobile = discy_options("hide_footer_mobile");
		...
		if ($top_footer == "on" || $bottom_footer == "on") {?>
			<footer class="footer<?php echo ($footer_widget_icons != "on"?" no-widget-icons":"").($footer_skin == "light"?" footer-light":"").(isset($hide_footer_mobile["top_footer"]) && $hide_footer_mobile["top_footer"] == "top_footer"?" hide-mobile-top-footer":"").(isset($hide_footer_mobile["bottom_footer"]) && $hide_footer_mobile["bottom_footer"] == "bottom_footer"?" hide-mobile-bottom-footer":"")?>" itemscope="" itemtype="https://schema.org/WPFooter">
...
if ($skin_switcher == 'on') {
	...
	$site_skin = (has_wpqa()?wpqa_dark_skin():"");

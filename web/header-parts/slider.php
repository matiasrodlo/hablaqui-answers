												...
												<div class="slider-colmun <?php echo ($button_block == "block"?"slider-block col8":"col6").($button_block == "block" || $align == "center"?" slider-colmun-3":"")?>">
													...
													<?php if ($button_block == "button") {
														if ($button == "question") {
															...
															$filter_class = "question";
															$slider_button_class = "wpqa-question";
															$button_link = (has_wpqa()?esc_url_raw(add_query_arg(array("type" => "poll"),wpqa_add_question_permalink())):"#");
															$button_text = esc_html__("Add A Poll","discy");
														}else if ($button == "post") {
															$filter_class = "post";
															...
															<div class="panel-login panel-un-login" id="login-panel">
																...
																<?php if ($activate_register != "disabled") {?>
																	<div class="pop-footer">
																		<?php echo '<a href="'.(has_wpqa()?wpqa_signup_permalink():"#").'" class="signup-panel">'.esc_html__( 'Sign Up Here', 'discy' ).'</a>';?>
																	</div><!-- End pop-footer -->
																<?php }?>
															</div><!-- End login-panel -->

...
if (!function_exists('discy_options')):
	function discy_options($name,$default = false) {
		...
		$options = $options + $styling_options + $mobile_options;
...
define("discy_theme_version","5.6.0");
define("discy_wpqa_plugin_version","6.0.0");
...
if (!function_exists('discy_get_aq_resize_img_url')) :
	function discy_get_aq_resize_img_url($img_width_f,$img_height_f,$img_lightbox = "",$thumbs = "",$gif = false,$title = "") {
		if (empty($thumbs)) {
...
if (!function_exists('discy_get_aq_resize_img')) :
	function discy_get_aq_resize_img($img_width_f,$img_height_f,$img_lightbox = "",$thumbs = "",$gif = false,$title = "",$srcset = "",$class = "") {
		$last_image = discy_get_aq_resize_img_url($img_width_f,$img_height_f,$img_lightbox,$thumbs,$gif,$title);
		if (isset($last_image) && $last_image != "") {
			if ($srcset != "") {
				$last_image_2 = discy_get_aq_resize_img_url($img_width_f*2,$img_height_f*2,$img_lightbox,$thumbs,$gif,$title);
			}
